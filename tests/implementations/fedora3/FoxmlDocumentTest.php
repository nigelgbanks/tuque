...
';
  ...
  public function testFOXMLDSDC() {
    ...
    $this->assertInstanceOf('Tuque\Fedora\v3\FedoraDatastream', $this->object['DC']);
    $this->assertEquals('DC', $this->object['DC']->id);
  }

  public function testFOXMLDSX() {
    $this->assertTrue(isset($this->object['INLINE']));
    $this->assertInstanceOf('Tuque\Fedora\v3\FedoraDatastream', $this->object['INLINE']);
  ...
  public function testFOXMLDSM() {
    ...
    $this->assertInstanceOf('Tuque\Fedora\v3\FedoraDatastream', $this->object['MANAGED']);
  ...
  public function testFOXMLDSR() {
    ...
    $this->assertInstanceOf('Tuque\Fedora\v3\FedoraDatastream', $this->object['REDIRECT']);
  ...
  public function testFOXMLDSE() {
    ...
    $this->assertInstanceOf('Tuque\Fedora\v3\FedoraDatastream', $this->object['EXTERNAL']);
