 ...
 */
interface AbstractDatastream extends Countable, ArrayAccess, IteratorAggregate {
   ...
   * problems after unserialization.
   *
   ...
   * Unsets public members.
   *
   * Required for child classes to funciton properly with MagicProperties.
   *
