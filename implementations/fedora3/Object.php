...
abstract class AbstractFedoraObject extends AbstractObject {
   ...
   * @var string
   */
  protected $fedoraDatastreamClass = 'Tuque\Fedora\v3\FedoraDatastream';
  /**
   ...
   * @var string
   */
  protected $newFedoraDatastreamClass = 'Tuque\Fedora\v3\NewFedoraDatastream';
  /**
   * The name of the class to use for RelsExt
   *
   * @var string
   */
  protected $fedoraRelsExtClass = 'Tuque\Fedora\v3\FedoraRelsExt';
